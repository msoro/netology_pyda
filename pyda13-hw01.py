...
month: str = input("Введите месяц рождения [напр.Август]:")
year = int(input("Введите год рождения:"))

if (22 <= date <= 31 and month == 'Декабрь') or (month == 'Январь' and 1 <= date <= 20):
    print("Знак зодиака:Козерог")
elif (21 <= date <= 31 and month == 'Январь') or (month == 'Февраль' and 1 <= date <= 18):
    print("Знак зодиака:Водолей")
elif (19 <= date <= 29 and month == 'Февраль') or (month == 'Март' and 1 <= date <= 20):
    print("Знак зодиака:Рыбы")
elif (21 <= date <= 31 and month == 'Март') or (month == 'Апрель' and 1 <= date <= 19):
    print("Знак зодиака: Овен")
elif (20 <= date <= 30 and month == 'Апрель') or (month == 'Май' and 1 <= date <= 20):
    print("Знак зодиака:Телец")
elif (21 <= date <= 31 and month == 'Май') or (month == 'Июнь' and 1 <= date <= 21):
    print("Знак зодиака:Близнецы")
elif (22 <= date <= 30 and month == 'Июнь') or (month == 'Июль' and 1 <= date <= 22):
    print("Знак зодиака:Рак")
elif (23 <= date <= 31 and month == 'Июль') or (month == 'Август' and 1 <= date <= 22):
    print("Знак зодиака:Лев")
elif (23 <= date <= 31 and month == 'Август') or (month == 'Сентябрь' and 1 <= date <= 22):
    print("Знак зодиака:Дева")
elif (23 <= date <= 30 and month == 'Сентябрь') or (month == 'Октябрь' and 1 <= date <= 23):
    print("Знак зодиака:Весы")
elif (24 <= date <= 31 and month == 'Октябрь') or (month == 'Ноябрь' and 1 <= date <= 22):
    print("Знак зодиака:Скорпион")
elif (23 <= date <= 30 and month == 'Ноябрь') or (month == 'Декабрь' and 1 <= date <= 21):
